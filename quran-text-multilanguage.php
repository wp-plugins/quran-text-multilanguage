...
<style>
	...
	.quran { font-family: Traditional Arabic;color:#<?php echo get_option('text_quran_arabic'); ?>;border-right: 1px solid #<?php echo get_option('background_quran_arabic'); ?>;border-left: 1px solid #<?php echo get_option('background_quran_arabic'); ?>; font-size: 28px; direction: rtl;background-color:#<?php if(!get_option('background_quran_arabic')){echo "EFF0F0";}else{ echo get_option('background_quran_arabic');} ?>}
